...
import { checkConnection, createPost, likePost, commentPost, flagPost, removePost, getPost, listPosts, getPostCount } from "../../lib/stellar.js";
import { 
    Heart, MessageCircle, AlertTriangle, Trash2, PenTool, Zap, 
    BookOpen, User, Wallet, ArrowLeft, Loader2, Search, BarChart3, ChevronRight 
} from "lucide-react";
    ...
    const runAction = async (action) => {
        ...
        try {
            ...
            if (errorMsg.includes("Error(Contract, #3)")) {
                errorMsg = "Duplicate Post ID! This ID is already taken. Please choose a unique Post ID to publish.";
                    ...
                    {activeTab === 0 && (
                        <div className="content-panel glass fade-in">
                            ...
                            <div className="input-grid">
                                ...
                                <div className="input-group">
                                    <label>Author</label>
                                    <input name="author" value={form.author} onChange={setField} className="premium-input" placeholder="G..." />
                                </div>
                            </div>
                        ...
                        <div className="content-panel glass fade-in">
                            ...
                            <div className="input-grid">
                                ...
                                <div className="input-group">
                                    ...
                                    <input name="liker" value={form.liker} onChange={setField} className="premium-input" placeholder="G..." />
                                </div>
                                <div className="input-group">
                                    <label>Commenter Address</label>
                                    <input name="commenter" value={form.commenter} onChange={setField} className="premium-input" placeholder="G..." />
                                </div>
                            </div>
