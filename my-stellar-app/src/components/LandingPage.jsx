    ...
    return (
        <div ref={heroRef} className="landing-container">
            ...
            <div className="landing-content glass hero-main">
                <div className="hero-text hero-badge">Stellar Soroban Project 20</div>
                <h1 className="hero-text title-gradient">Decentralized<br />Community Hub</h1>
                <p className="hero-text subtitle">
                    Experience the next generation of social interaction on the Stellar blockchain. Connect your wallet, share ideas, and engage seamlessly.
                </p>
                <div className="hero-text action-row">
                    ...
                    <a href="https://stellar.org" target="_blank" rel="noreferrer" className="secondary-btn">
                        <Rocket size={20} />
                        Learn More
                    </a>
                </div>
